...
const SITE_CONFIG = {
  ...
  privacy: {
    ...
    site:          'keyboardtest.app',
    controller:    'KeyboardTest.app',
    sections: [
      {
        title: '1. Overview',
        html: `<p>KeyboardTest.app ("we", "our", "the site") is committed to protecting your privacy.
      ...
      {
        title: '11. Contact',
        html: `<p>Questions? Contact us at <strong>privacy@keyboardtest.app</strong></p>`
      },
    ]
  },
  ...
  terms: {
    ...
    effectiveDate: '25 April 2025',
    jurisdiction:  'India',
    operator:      'KeyboardTest.app',
    sections: [
      {
        title: '1. Acceptance of Terms',
        html: `<p>By accessing or using KeyboardTest.app ("the Site", "the Service"), you agree to be
      ...
      },
      {
        ...
        html: `<p>KeyboardTest.app provides a free, browser-based utility that allows users to test the
      ...
      },
      {
        ...
        html: `<p>All content on this Site — including text, graphics, design, code, logos, and layout —
               is the intellectual property of KeyboardTest.app unless otherwise noted. You may not
      ...
      },
      {
        ...
        html: `<p>To the fullest extent permitted by law, KeyboardTest.app shall not be liable for any
      ...
      },
      {
        ...
        html: `<p>These Terms, together with our Privacy Policy, constitute the entire agreement between
               you and KeyboardTest.app regarding use of the Site.</p>`
      },
      {
        title: '13. Contact',
        html: `<p>Questions? Contact us at <strong>legal@keyboardtest.app</strong></p>`
      },
    ]
  }
